...
//
//	public Status(Cursor _status) {
//	//	user = (User)_status.get(WeiboDbAdapter.user);
//		
//		try {
//			System.out.println(_status.getString("_created_at"));
//			createdAt = parseDate(_status.getString("_created_at"), "EEE MMM dd HH:mm:ss z yyyy");
//		} catch (Exception e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
//		System.out.println(createdAt.toString());
//		id = _status.getString("_id");
//		mid= _status.getString("_mid");
//		idstr = _status.getLong("_idstr");
//		text = _status.getString("_text");
//		if(_status.containsKey("_source")){
//			source = new Source(_status.getString("_source"));
//		}
//		inReplyToStatusId = _status.getLong("_in_reply_to_status_id");
//		inReplyToUserId = _status.getLong("_in_reply_to_user_id");
//		inReplyToScreenName= _status.getString("_in_reply_to_screen_name");
//		
//		favorited = _status.getBoolean("_favorited");
//		truncated = _status.getBoolean("_truncated");
//		if(_status.containsKey("_thumbnail_pic")) {
//			thumbnailPic = _status.getString("_thumbnail_pic");
//		}
//		if(_status.containsKey("_bmiddle_pic")) {
//			bmiddlePic = _status.getString("_bmiddle_pic");
//		}
//		if(_status.containsKey("_original_pic")) {
//			originalPic = _status.getString("_original_pic");
//		}
//		repostsCount = _status.getInt("_reposts_count");
//		commentsCount = _status.getInt("_comments_count");
////		if(_status.containsKey("_annotations")) {
////			annotations = _status.getString("_annotations");
////		}
////		if(_status.containsKey("_retweeted_status")){
////			retweetedStatus= new Status(json.getJSONObject("_retweeted_status"));
////		}
//	//	mlevel = _status.getInt("_mlevel");
//		geo= _status.getString("_geo");
//		if(geo!=null &&!"".equals(geo) &&!"null".equals(geo)){
//			getGeoInfo(geo);
//		}
////		if(!json.isNull("visible")){
