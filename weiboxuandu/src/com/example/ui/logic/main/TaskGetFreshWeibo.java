...
public class TaskGetFreshWeibo implements RequestListener {
	
	Message _mess;
	public TaskGetFreshWeibo(Integer pageSize, Integer nowPage, Message mess) {
		System.out.println("TaskGetFreshWeibo " + nowPage + " " + pageSize);
