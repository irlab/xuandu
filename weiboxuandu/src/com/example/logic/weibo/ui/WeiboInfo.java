...
public class WeiboInfo extends Activity implements Runnable, IWeiboActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
     ...
     //   this.setContentView(R.layout.detailweibo);
		...
		this.setContentView(R.layout.weiboxx);
        MainService.allActivity.add(this);
        
        for(int i = 0; i < 100; i++) {
        	System.out.println(i + "            weiboInfo onCreate ----------------------");
        }
        initview();//初始化 页面 
        //又转发内容的布局
	...
	public void initview(){ 
	    try {
	    	...
	    	System.out.println("----------------------------------------------weiboInfo initView");
	    	commentlist = (ListView) this.findViewById(R.id.commentlist2);
...
//		});
	...
	public void init() {
		...
		System.out.println("WeiboInfo init() .........................................................!!!!!!!!!!!!!!!!!" + status.getId());
	...
	public void refresh(Object... param) {
		System.out.println(" weiboinfo   refresh..................");
	...
	//	switch(flag) {
			...
			//	weiboNum = nowStatus.size();
				mCommentAdapter = new commentAdapter(this, nowStatus);
...
//				}
//				weiboNum += nowStatus.size();
//				mCommentAdapter.addmoreDate(nowStatus);
//			}
